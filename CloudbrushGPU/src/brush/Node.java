...
//		String bs = bstr.substring(0, K);
  ...
  /*  public boolean hasGrayEdge(String et, String nid) throws IOException
    ...
    class BlackEdgeComparator implements Comparator<String> { // possibly change to Comparator<String>?
        public int compare(String element1, String element2) { // had to change element1 & 2 from Object to String
    ...
    class BlackEdgeComparator2 implements Comparator<String> { // possibly change to Comparator<String>?
    ...
    public String selectBlackEdge(String dir) {
        ...
        if (black_edges != null) {
            Collections.sort(black_edges, new BlackEdgeComparator()); //TODO: add type safety to Comparison
            ...
            if (edge_list.size() >= 2) {
                ...
                //\\  Select best edge
                Collections.sort(black_edges, new BlackEdgeComparator2()); //TODO: Add type safety 
                for(int i=0; i < black_edges.size(); i++) {
                    //\\
                    String [] vals = black_edges.get(i).split("\\|");
                    if (vals[0].equals(dir + "f") || vals[0].equals(dir +"r")){
    ...
    public static String Consensus(List<String> edge_list , float majority, float threshold) {
        ...
        class ConsensusComparator implements Comparator<String> { //Added <String>
            public int compare(String element1, String element2) { // Changed element1 and 2 to String type
                String obj1 = (String) element1;
                String obj2 = (String) element2;
                //con + "|" + node_id + "|" + str_raw + "|" + oval_size + "|" + cov + "|" + end;
                String[] val1 = obj1.split("!");
        ...
        //\\\
        Collections.sort(edge_list, new ConsensusComparator()); //TODO: Add type safety
        if (edge_list.size() >= 2) {
            //int consensus_len = edge_list.get(1).substring(0, edge_list.get(1).indexOf("!")).length();
    ...
    public static String Consensus2(List<String> edge_list , float threshold){
        String consensus = null;
        class ConsensusComparator implements Comparator <String>{  // added <String>
            public int compare(String element1, String element2) { // Changed element1 and element2 to String type
                String obj1 = (String) element1;
                String obj2 = (String) element2;
                //con + "|" + node_id + "|" + str_raw + "|" + oval_size + "|" + cov + "|" + end;
                String[] val1 = obj1.split("!");
    ...
    public List<String> filterAllPair(List<String> reads){
        List<String> verify_reads = new ArrayList<String>(); // added <String> for type safety. 
	...
	{
        List<String> tmp = new ArrayList<String>(); // added String for type safety
